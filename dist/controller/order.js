...
var getTotalAmount = function (orderItems) {
    return (orderItems.reduce(function (acc, item) { return acc + item.price * item.quantity; }, 0) * BASE_UNIT);
};
/*
*
* @param request
...
var createOrder = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var stripeClient, _a, user, orderItems, deliveryAddress, totalPrice, totalAmount, paymentIntent, order, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                error_1 = _b.sent();
                console.error('error in createOrder', error_1);
